...
class NoteAICrawler:
    ...
    def __init__(
        ...
        Args:
            ...
            only_yesterday (bool): 昨日の記事のみを取得するかどうか
        """
    ...
    def search_articles(self):
        ...
        for page in tqdm(range(1, self.max_pages + 1), desc="ページ"):
            try:
                params = {"q": self.search_keyword, "page": page, "sort": "new"}
    ...
    def filter_yesterday_articles(self):
        ...
        for article in self.articles:
            ...
            if published_date and published_date.startswith(yesterday_str):
                filtered_articles.append(article)

        print(f"昨日({yesterday_str})の記事は {len(filtered_articles)}/{len(self.articles)} 件でした。")
...
if __name__ == "__main__":
    ...
    only_yesterday = True  # 昨日の記事のみを取得するかどうか
